                            ...
                            <div class="table-responsive">
                                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    <thead>
                                        ...
                                        <a href="{{ route('donasi.create') }}" method="GET" class="btn btn-primary btn-icon-split" style="margin-bottom: 10px;">
                                    ...
                                    <div>
                                        <tr>
                                            ...
                                            <th rowspan="1" colspan="1">Pesan</th>
                                        </tr>
                                    </div>
                                    <tbody>      
                                        @foreach ($alldonasi as $key => $r)
                                        <tr>
                                            <td>{{$key + 1}}</td>
                                            <td>{{$r->nama}}</td>
                                            <td>{{$r->email}}</td>
