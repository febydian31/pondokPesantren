        ...
        <div class="row gy-4">
            <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-card isi program-card">
                    <h3>Visi</h3>
                    <p>TERWUJUDNYA SANTRI PENGHAFAL QUR’AN YANG RELIGIUS, BERINTEGRITAS, BERKOMPETEN, DAN BERWAWASAN GLOBAL</p>
                </div>
            </div>
            <div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="service-card isi program-card">
            ...
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card">
                        ...
                        <h4>Miftakhurrohmad Sidik Wahyudi</h4>
                        <h2>Ketua Yayasan</h2>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card">
                        <img class="gambar" src="{{ asset('images/logo.png') }}" alt="">
                        <h4>Shohiba Mazaya Mubaroka, S.H., M.Kn.</h4>
