                        ...
                        <div class="">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('no_induk') is-invalid @enderror" value="{{ old('no_induk') }}" name="no_induk" placeholder="noInduk">
                                    @error('no_induk')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" placeholder="Alamat" name="address" style="height: 100px">{{ old('address') }}</textarea>
                                @error('address')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('father_address') is-invalid @enderror" placeholder="alamat" name="father_address" style="height: 100px">{{ old('father_address') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('mother_address') is-invalid @enderror" placeholder="alamat" name="mother_address" style="height: 100px">{{ old('mother_address') }}</textarea>
