        ...
        <div class="card-body">
            <form action="{{ route('admin.article.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <img class="mb-3" id="preview" src="#" alt="Preview Gambar"
                        style="max-width: 550px; margin-top: 10px; display: none;">
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.article.index') }}" class="btn btn-info">Kembali</a>
