                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name') }}" name="name" placeholder="Contoh : Ahmad Ibrahim">
                                @error('name')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control @error('no_induk') is-invalid @enderror"
                                    value="{{ old('no_induk') }}" name="no_induk" placeholder="Contoh : 129334834343423">
                                @error('no_induk')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control @error('nisn') is-invalid @enderror"
                                    value="{{ old('nisn') }}" name="nisn" placeholder="Contoh : 004322864">
                                @error('nisn')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('father_name') is-invalid @enderror"
                                        value="{{ old('father_name') }}" name="father_name" placeholder="Contoh : Paijo">
                                    @error('father_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('mother_name') is-invalid @enderror"
                                        value="{{ old('mother_name') }}" name="mother_name" placeholder="Contoh : Sumina">
                                    @error('mother_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('father_job') is-invalid @enderror"
                                        value="{{ old('father_job') }}" name="father_job" placeholder="Contoh : Guru">
                                    @error('father_job')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('mother_job') is-invalid @enderror"
                                        value="{{ old('mother_job') }}" name="mother_job" placeholder="Contoh : Guru">
                                    @error('mother_job')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('no_telp') is-invalid @enderror"
                                        value="{{ old('no_telp') }}" name="no_telp" placeholder="Contoh : 0812">
                                    @error('no_telp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
