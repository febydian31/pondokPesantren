                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name', $registration->name) }}" name="name" placeholder="Nama Legkap">
                                @error('name')
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control @error('no_induk') is-invalid @enderror"
                                    value="{{ old('no_induk', $registration->no_induk) }}" name="no_induk"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" class="form-control @error('nisn') is-invalid @enderror"
                                    value="{{ old('nisn', $registration->nisn) }}" name="nisn" placeholder="NISN">
                                @error('nisn')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="datepicker"
                                    ...
                                    value="{{ old('birth', $registration->birth) }}" name="birth"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('father_name') is-invalid @enderror"
                                        value="{{ old('father_name', $registration->father_name) }}" name="father_name"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('mother_name') is-invalid @enderror"
                                        value="{{ old('mother_name', $registration->mother_name) }}" name="mother_name"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('father_job') is-invalid @enderror"
                                        value="{{ old('father_job', $registration->father_job) }}" name="father_job"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('mother_job') is-invalid @enderror"
                                        value="{{ old('mother_job', $registration->mother_job) }}" name="mother_job"
                            ...
                            <div class="form-group">
                                ...
                                <input id="father_address" type="hidden" name="father_address"
                                    ...
                                    value="{{ old('father_address', $registration->father_address) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="mother_address" type="hidden" name="mother_address"
                                    ...
                                    value="{{ old('mother_address', $registration->mother_address) }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control @error('no_telp') is-invalid @enderror"
                                        value="{{ old('no_telp', $registration->no_telp) }}" name="no_telp"
                                        placeholder="No Telp">
                                    @error('no_telp')
                                        <div class="invalid-feedback">
                                            {{ $message }}
